...
class ProductController {
    ...
    async cart(req, res) {
        res.render('pages/cart', { error: req.flash('error'), success : req.flash('success')});
    }
    async buy(req, res) {
        const slug = req.params.slug;
        try {
    ...
    async productDetail(req, res) {
        ...
        try {
            ...
            res.render('pages/contentDetails', {product, error: req.flash('error'), success : req.flash('success')});
